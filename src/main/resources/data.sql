...
INSERT INTO oauth_users (id, user_name, password, account_expired, account_locked, credentials_expired, enabled,provider)
        VALUES (  1,
                  'james',
                  '$2a$10$6Ma.GWHneStxnAz/ktuGgex/oU2fvEit3L3Cih3i93RUMI8Mt2.O2', FALSE, FALSE, FALSE, TRUE,'DOCKER');
...
INSERT INTO oauth_users (id, user_name, password, account_expired, account_locked, credentials_expired, enabled,provider)
        VALUES (  2,
                  'matthew',
                  '$2a$10$lQR.gETjhgplcbLOtDrEv.irf8zSjzoW0T1vykBHdsNwTrqnQ6im6', FALSE, FALSE, FALSE, TRUE,'DOCKER');

 /* tiago passowrd : tgPWD */     
INSERT INTO oauth_users (id, user_name, password, account_expired, account_locked, credentials_expired, enabled,provider)
        VALUES ( 3 ,
                  'tiago',
                  '$2a$10$H5wwEW8xZVXssRs5svhhp.yhHZl1ApzfxWGP2cZko1PfD.xxNxA.i', FALSE, FALSE, FALSE, TRUE,'DOCKER');
              
 /* lucas passowrd : lcsPWD */         
INSERT INTO oauth_users (id, user_name, password, account_expired, account_locked, credentials_expired, enabled,provider)
        VALUES ( 4,
                  'lucas',
                  '$2a$10$PPrf2YTMV50WEyE.w.qUJuNKb3pZ7lf04IbrnrGBB5Ey1D.SDo5bW', FALSE, FALSE, FALSE, TRUE,'DOCKER');
